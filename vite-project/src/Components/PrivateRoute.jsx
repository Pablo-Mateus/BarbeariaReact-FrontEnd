...
const PrivateRoute = () => {
  ...
  React.useEffect(() => {
    ...
    checkAuth();
    // Este console.log roda na primeira renderização, antes do fetch.
    // Ele mostrará o valor inicial de `isAuthenticated` (false).
    // console.log("PrivateRoute: isAuthenticated no primeiro render:", isAuthenticated);
